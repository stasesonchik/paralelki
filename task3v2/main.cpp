...
void initialize_matrix(std::vector<std::vector<double>>& A,
                       std::vector<double>& b,
                       int matrix_size) {
    A.assign(matrix_size, std::vector<double>(matrix_size, 1.0));
    b.assign(matrix_size, matrix_size + 1.0);
...
int main(int argc, char* argv[]) {
    ...
    initialize_matrix(A, b, matrix_size);
